...
// Тесты для AuthUserRequest
func TestAuthUserRequest_Validations(t *testing.T) {
	// Тест успешной валидации
	t.Run("Valid Request", func(t *testing.T) {
		validRequest := AuthUserRequest{
			Login:    "test_user",
	...
	t.Run("Empty Login", func(t *testing.T) {
		invalidRequest := AuthUserRequest{
			Password: "secure_password",
		}
...
// Тесты для AuthUserResponse
func TestAuthUserResponse_Validations(t *testing.T) {
	// Тест успешной инициализации
	t.Run("Valid Response", func(t *testing.T) {
		validResponse := AuthUserResponse{
			JWT:    "valid.jwt.token",
			UserID: "user123",
		}
	...
	t.Run("Empty JWT", func(t *testing.T) {
		emptyJWTResponse := AuthUserResponse{
			UserID: "user123",
		}
	...
	t.Run("Empty UserID", func(t *testing.T) {
		emptyUserIDResponse := AuthUserResponse{
			JWT: "valid.jwt.token",
		}
	...
	t.Run("Empty Response", func(t *testing.T) {
		emptyResponse := AuthUserResponse{}
